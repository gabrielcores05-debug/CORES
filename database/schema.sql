-- Esquema Oficial de Base de Datos para CORES COMUNICACIONES S.A.S.
...
-- Usuarios Administradores y Clientes de Muestra (Condoto, Chocó)
...
('Sistema', 'Instalación', 'Base de Datos', 'Inicialización oficial del sistema CORES COMUNICACIONES S.A.S. en Condoto, Chocó', '127.0.0.1');
